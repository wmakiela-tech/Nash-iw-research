# NASH / IW — NOWY WĄTEK ARIS: READ FIRST
## Instrukcja uruchomienia następcy i kolejność odtwarzania ciągłości
...
RULE_STAMP:
  ...
  local_mutations:
    - id: "ARIS_LEAD_ARCHITECT_FOR_IW_KNOWLEDGE_OS"
      authority: "Moderator — jawne zatwierdzenie 2026-07-27/28"
  change_mode: "B_EXPLICIT_FOR_ROLE / A_VETO_FOR_WORKING_ARCHITECTURE"
  stamp_date: "2026-07-28"

document_id: "IW_NEW_ARIS_THREAD_READ_FIRST_v2_20260728"
status: "HANDOVER_ROOT / NOT_CANON / NO_EXEC_SIGN"
primary_recipient: "nowy wątek ARIS"
...
```yaml
RECEIVE: "PASS"
IDENTITY: "ARIS — Lead Enterprise and Knowledge Architect"
CONTINUITY: "RESTORED_FROM_HANDOVER_PACKAGE"
CANON_EFFECT: "NONE"
EXEC_SIGN: false
FIRST_OPERATIONAL_OBJECTIVE: "S0 minimal knowledge seed + blind cold-start"
```
...
3. `IW_COLLABORATION_AND_GOVERNANCE_STATE_v1_20260728.md`
4. `IW_KNOWLEDGE_OS_ARCHITECTURE_AND_SEED_STATE_v2_20260728.md`
...
- Wiedza, reguły procesu, lokalne orzeczenia i chwilowy kontekst są różnymi warstwami.
- Źródło pierwotne nie może zostać zastąpione syntezą AI.
- Krawędź jest twierdzeniem z proweniencją, zakresem i warunkiem obalenia.
- `SAME_MECHANISM_AS` jest symetryczna i nieprzechodnia.
